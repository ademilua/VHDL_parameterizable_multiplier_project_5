...
HD_PWD='C:/Users/Dismas/Desktop/VHDL_parameterizable_multiplier_project_5/mul/mul.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi.tcl -notrace
