...
HD_PWD='C:/Users/Dismas/Desktop/VHDL_parameterizable_multiplier_project_5/parameterizable_adder_project/parameterizable_adder_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bits_RCA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source four_bits_RCA.tcl -notrace
